...
def add_host(request, id_env):
    ...
    return render(request, 'add/../templates/normal_user/add_host.html', locals())
...
def edit_host(request, id_host):
    ...
    return render(request, 'edit/../templates/normal_user/edit_host.html', locals())
...
def host_details(request, id_host):
    ...
    return render(request, 'details/../templates/normal_user/host_details.html', locals())
...
def role_details(request, id_host, id_role):
    ...
    return render(request, 'details/../templates/normal_user/role_details.html', locals())
